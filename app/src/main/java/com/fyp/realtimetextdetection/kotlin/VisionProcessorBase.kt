...
import com.fyp.realtimetextdetection.CameraImageGraphic
import com.fyp.realtimetextdetection.FrameMetadata
import com.fyp.realtimetextdetection.GraphicOverlay
import com.fyp.realtimetextdetection.InferenceInfoGraphic
import com.fyp.realtimetextdetection.ScopedExecutor
...
abstract class VisionProcessorBase<T>(context: Context) : VisionImageProcessor {
  ...
  private fun resetLatencyStats() {
   ...
   open fun detectInImage(image: MlImage): Task<T> {
   ...
   open fun isMlImageEnabled(context: Context?): Boolean {
    return false
  }
}
